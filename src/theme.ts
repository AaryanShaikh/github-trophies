export const COLORS: {[name: string]: Theme} = {
  ...
  gitdimmed: {
    ...
    TEXT: "#9f9f9f",
    LAUREL: "#9f9f9f",
    SECRET_RANK_1: "#12c2e9",
    SECRET_RANK_2: "#c471ed",
    SECRET_RANK_3: "#f64f59",
    SECRET_RANK_TEXT: "#9f9f9f",
    NEXT_RANK_BAR: "#B400FF",
    S_RANK_BASE: "#b400ff",
    S_RANK_SHADOW: "#1d1e26",
    S_RANK_TEXT: "#f9f9f9",
    A_RANK_BASE: "#b400ff",
    A_RANK_TEXT: "#f9f9f9",
    A_RANK_SHADOW: "#1d1e26",
    B_RANK_BASE: "#b400ff",
    B_RANK_SHADOW: "#1d1e26",
    B_RANK_TEXT: "#f9f9f9",
    DEFAULT_RANK_BASE: "#b400ff",
    DEFAULT_RANK_SHADOW: "#1d1e26",
    DEFAULT_RANK_TEXT: "#f9f9f9",
  },
  tokyonight: {
    BACKGROUND: "#1a1b27",
    TITLE: "#70a5fd",
